...
const Footer = () => {
  return (
    <footer className="bg-[#f8f9fa] dark:bg-[#0D0D0D] relative overflow-hidden pt-36 pb-12 px-6 border-t border-gray-200 dark:border-white/5 transition-colors duration-300">
      ...
      <div className="max-w-5xl mx-auto relative z-10 text-center">
        ...
        <motion.p
          ...
          className="text-gray-600 dark:text-gray-400 mt-8 text-sm leading-relaxed max-w-lg mx-auto"
        >
